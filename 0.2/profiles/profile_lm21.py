...
START = {
    # profile name
    PROFILE_NAME: "P02.2 Camera - LM21",
    # used for file saving purposes
    PROFILE_NICKNAME: "LM21",
    PROFILE_TANGOATTR: [
            # NICK + CMD; CMD - lambda function to execute
            {
                # must be unique
                NICK: "LM21",
                CMD: lambda: read_attribute("haspp02ch2:10000/hasylab/p02_lm21/output", "frame", expected_type=list),

                # parameters for the VIEW ROI - x and y are inverted, w and h are same
                ROI_VIEW:   [ 167, 282,  70, 70],
